...
const Sidebar = () => {
  ...
  return (
    <div className={`sticky top-0 z-30 h-14 p-4 border-b flex items-center ${Toggle === "light" ? "bg-white border-gray-200" : "bg-gray-900 border-gray-700 text-white"}`}>
      <div className="flex justify-between items-center w-full">
        ...
        <div className="flex items-center gap-3 sm:gap-5">
          <button className="p-1 rounded-full hover:bg-gray-200 hidden sm:block">
